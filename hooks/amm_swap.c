...
/* CORRECT constant-product AMM swap, NATIVE-PRODUCT regime. Reserves RX,RY in state; swap params
 ...
 * prove_constant_product => PROVEN (scope: reserves in the native-product regime). */
...
int64_t hook(uint32_t reserved)
{
    ...
    XAHC_REQUIRE(newRX * newRY >= oldRX * oldRY, "k dropped — would drain pool");
