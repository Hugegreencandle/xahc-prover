...
/* BUGGY SUBSCRIPTION (no trigger lock -> fires on any tx) — the Cron-native recurring-payment Hook.
 *
...
int64_t hook(uint32_t reserved)
{
    ...
    /* BUG: no trigger lock — emits regardless of what tx triggered the hook */
