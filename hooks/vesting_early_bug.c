...
/* BUGGY VESTING (no cliff gate -> releases before unlock time) — the Cron-native scheduled-release Hook.
 *
...
int64_t hook(uint32_t reserved)
{
    ...
    /* BUG: no time gate — releases whether or not the cliff has passed */
